    ...
    <div class="min-h-screen flex items-center justify-center bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow-lg">
            ...
            <form action="../actions/register_action.php" method="POST" class="mt-8 space-y-6">
                ...
                <button type="submit" class="bg-blue-500 text-white p-2 rounded-md w-full mt-4 hover:bg-blue-600 transition duration-200">Register</button>
            </form>
            <p class="mt-4 text-center text-sm text-gray-600">Already have an account? <a href="login.php" class="text-blue-500">Login here</a></p>
        </div>
    </div>
</body>
